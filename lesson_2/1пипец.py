...
elif year_of_birth > year:
    print("Ошибка: неверный год рождения")
    
if month < month_of_birth :
    print("путь открыт")
elif month < month_of_birth or month == month_of_birth and day <= day_of_birth:
    print("путь открыт")
    
if year - year_of_birth > 18:
    print("путь открыт")
elif year - year_of_birth == 18 and month_of_birth < 12:
    print("путь открыт")
